...
import DevTool from '@site/src/components/DevTool/DevTool'
import BasicAnimations from './BasicAnimations'
import BasicAnimationsSource from '!!raw-loader!./BasicAnimations'

<DevTool source={BasicAnimationsSource} component={BasicAnimations} />
