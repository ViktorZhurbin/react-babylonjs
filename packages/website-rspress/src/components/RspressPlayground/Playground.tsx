...
import React, { type HTMLAttributes, type ReactNode, useCallback, useState } from 'react'
import getImport, { imports } from '_rspress_playground_imports'
import { usePageData } from '@rspress/core/runtime'
// import { Runner } from './Runner'
import { Editor } from './Editor'
import { MyRunner } from './_MyRunner'
...
export default function Playground(props: PlaygroundProps) {
  ...
  const useReverseLayout = direction === 'horizontal' && editorPosition === 'left'

  const monacoLanguage = language === 'tsx' || language === 'ts' ? 'typescript' : 'javascript'
  ...
  return (
    <div className={classNames} {...rest}>
      ...
      <MyRunner code={code} />
      <Editor value={code} onChange={handleCodeChange} language={monacoLanguage} />
