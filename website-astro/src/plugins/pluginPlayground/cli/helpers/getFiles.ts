 ...
 */
export const getFiles = (params: { resolvedPath: string; importPath: string }) => {
  ...
  if (tsxToJsxResult?.code) {
    files.jsx[EntryFiles.jsx] = tsxToJsxResult.code
    // await formatCode(tsxToJsxResult.code, resolvedPath)
  }
